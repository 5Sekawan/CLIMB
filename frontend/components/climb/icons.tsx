...
export function ClimbLogo({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="none"
...
export function VoxelIcon({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function PickaxeIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M19.686 8.314a12.501 12.501 0 0 1 1.356 10.225 1 1 0 0 1-1.751-.119 22 22 0 0 0-3.393-6.318" />
    </svg>
  );
}
...
export function LayersIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="m22.54 12.43-1.96-.89" />
      <path d="m2 12 1.95.89" />
      <path d="m22.54 16.43-10 4.55a2 2 0 0 1-1.66 0l-9.42-4.29" />
      <path d="m2 16 10 4.55a2 2 0 0 0 1.66 0L22 16" />
    </svg>
  );
}
