    ...
    <div className="mx-auto w-full max-w-7xl px-6 py-8">
      ...
      <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-5">
          ...
          >
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-foreground">
                Upload Actual Grade Data
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                Drag & drop CSV file from lab results, or click to browse
              </p>
            </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="rounded-xl border border-border bg-card shadow-climb-1">
            ...
            <div className="divide-y divide-border max-h-64 overflow-y-auto">
              {blockData.map((row) => (
                <div
                  key={row.block}
                  className="grid grid-cols-5 gap-2 px-4 py-2.5 hover:bg-muted/50 transition-colors duration-climb-fast"
                >
          ...
          <InsightCard
            icon={<BrainIcon className="h-4 w-4" />}
            title="Drift Analysis Summary"
          >
            <p className="text-xs leading-relaxed">
              Model shows systematic <strong className="text-foreground">over-estimation bias of +5.2%</strong> in
              B7 sector blocks where thermal anomaly exceeds 2.0K above
              ambient. Recommend applying SWIR correction factor before next
              inference cycle.
            </p>
          </InsightCard>
        </div>
